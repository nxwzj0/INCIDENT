...
// logic処理読み込み
require_once('./logic/IncidentRelateUserCheckLogic.php');

// dto処理読み込み
require_once('./dto/IncidentRelateUserCheckDto.php');

class IncidentRelateUserCheckAction extends CommonAction {

    public function index() {

        // 実例化Dto
        $condtionDto = new IncidentRelateUserCheckDto();
        // 共通パラメータ配列取得
        $P = $GLOBALS[P];
        // 画面からパラメータ取得
        ...
        // 実例化Logic
        $logic = new IncidentRelateUserCheckLogic();
        // 実行Logic
