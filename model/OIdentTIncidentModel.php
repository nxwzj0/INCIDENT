...
SQL_INCIDENT_INFO;
        ...
        $tpl = new ExecTemplate($html, $SQL_INCIDENT_INFO);
...
// ::: 2018.03.02 [#44] ページング修正：インシデント検索、インシデントモーダル Add Start newtouch
    public function getIncidentWithRelCount($conditions){
        $SQL_INCIDENT_INFO = <<< SQL_INCIDENT_INFO
                SELECT 
                    count(*) COUNT
                FROM
...
SQL_INCIDENT_INFO;
    ...
    public function getIncidentCount($conditions){
        $SQL_INCIDENT_INFO = <<< SQL_INCIDENT_INFO
                SELECT 
                    count(*) COUNT
                FROM
...
SQL_INCIDENT_INFO;
    ...
    public function getIncidentWithRelByKeywordCount($conditions){
        $SQL_INCIDENT_INFO = <<< SQL_INCIDENT_INFO
                SELECT 
                    count(*) COUNT
                FROM
...
SQL_INCIDENT_INFO;
    ...
    public function getIncidentByKeywordCount($conditions){
        $SQL_INCIDENT_INFO = <<< SQL_INCIDENT_INFO
                SELECT 
                    count(*) COUNT
                FROM
