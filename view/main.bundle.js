...
var EditComponent = /** @class */ (function () {
    function EditComponent(route, jsonpService, postService, router, loginService, _localeService) {
        ...
        this.sotiCd = ""; // 装置分類CD
        this.sotiNm = ""; // 装置分類名
        this.kisyuTypeCd = ""; // 機種区分CD
        this.kisyuTypeNm = ""; // 機種区分名
        this.kisyuNm = ""; // 機種名  
        this.productTriggerCd = ""; //障害状況トリガーCD
        this.productTriggerNm = ""; //障害状況トリガー名
        this.productHindoCd = ""; //障害状況頻度CD
    ...
    EditComponent.prototype.setDspParam = function (data) {
        ...
        // this.productTypeCd = data.productTypeCd; //機種区分CD
        // this.productTypeNm = data.productTypeNm; //機種区分名
        this.sotiCd = data.sotiCd; //装置分類CD
        this.sotiNm = data.sotiNm; //装置分類名
        this.kisyuTypeCd = data.kisyuTypeCd; //機種区分CD
        this.kisyuTypeNm = data.kisyuTypeNm; //機種区分名
